...
# Load models
rf_model = joblib.load('random_forest_model.pkl')  # Model Random Forest
dt_model = joblib.load('decision_tree_model.pkl')  # Model Decision Tree
